...
See `doc/readme-qt.rst` for instructions on building SecKCoin-Qt, the
...
on an OS X 10.6 64-bit machine fails. Official release builds of SecKCoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `SecKCoin-Qt.app` is easy:
